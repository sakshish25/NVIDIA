...
public class BuyConnection extends JFrame
{
	...
	public BuyConnection()
	{
		...
		GradientPanel mainPanel = new GradientPanel("/icon/Nvidia_UserSignUp.jpg");
	...
	public void handleSubmitButton(JTextField mobileField, JTextField userNameField, JComboBox<String> cityCombo)
	{
		...
		String query=null;
	       ...
	       try {
	           ...
	           String query1 = "SELECT * FROM broadband_plans WHERE phno='" + phoneNo + "' ;";
	   		ResultSet rs;
	   		...
	   		if(rs.next())
	   		{
	   			...
	   			JOptionPane.showConfirmDialog(this, "Users Plan Exists! Do you want to Buy a new Plan??s", "Confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE );
	   			
	   			int choice = JOptionPane.showConfirmDialog(this, "Plan Already Exist!! Update Plan??" ,"Confirm", JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
	       		
	           	if(choice == JOptionPane.YES_OPTION)
	           	{
	           	//generateAccountNo();
	           	query="update broadband_plans set planType = '"+planType+"', planPrice = '"+planPrice+"', planData = '"+planData+"',speed = '"+speed+"', planDuretion = '"+planDuration+"' where phno = '"+phoneNo+"';";
	           	//UPDATE qsp.broadband_plans SET planType = 'pro' WHERE (accountNo = '628771889');
	           	JOptionPane.showConfirmDialog(this, "updated!!","confirm",JOptionPane.YES_OPTION);
	           ...
	           query="insert into broadband_plans (phno, planType, planPrice, planData, speed, planDuretion, accountNo)" + "\n" +
